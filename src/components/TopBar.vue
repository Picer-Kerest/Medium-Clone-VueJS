<template>
  <nav class="navbar navbar-light">
    <div class="container">
      <router-link class="navbar-brand" :to="{ name: 'home' }">Medium Clone</router-link>
      <ul class="nav navbar-nav pull-xs-right">
        ...
        <template v-if="isLoggedIn">
          <li class="nav-item">
            <router-link class="nav-link" :to="{ name: 'home' }" active-class="active"></router-link>
...
export default {
  name: "TopBar",
  computed: {
    ...mapGetters('auth', ['currentUser', 'isLoggedIn', 'isAnonymous', ]),
  }
}
</script>
